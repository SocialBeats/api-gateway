...
For full commit history, see [here](https://github.com/SocialBeats/api-gateway/compare/v2.0.3...v2.0.4).
...
No documentation changes.
## Fixes
- fix: fix problem with oas routes
...
For full commit history, see [here](https://github.com/SocialBeats/api-gateway/compare/v2.0.1...v2.0.2).
...
For full commit history, see [here](https://github.com/SocialBeats/api-gateway/compare/v2.0.0...v2.0.1).
...
No documentation changes.
## Fixes
- fix: social proxy fixed

## Continuous integration (CI)
No CI changes.
## Other changes
- Merge pull request #17 from SocialBeats/develop

## Full commit history

For full commit history, see [here](https://github.com/SocialBeats/api-gateway/compare/v1.0.2...v1.1.0).
